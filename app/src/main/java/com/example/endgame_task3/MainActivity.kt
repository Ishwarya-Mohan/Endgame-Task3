package com.example.endgame_task3
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var guessedUserInput = findViewById<TextInputLayout>(R.id.guessednumber)
        val clickMeButton = findViewById<TextView>(R.id.clickEvent)
        val viewResult = findViewById<TextView>(R.id.displayResult)
        var count = 0
